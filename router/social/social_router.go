...
func RegisterSocialRoutes(r *gin.RouterGroup,
	...
	socialGroup.Use(auth.JWTAuth())
	{
		...
		if commentAPI != nil {
			...
			socialGroup.PATCH("/comments/:id", commentAPI.UpdateComment)
		...
		if collectionAPI != nil {
			...
			socialGroup.PATCH("/collections/:id", collectionAPI.UpdateCollection)
			...
			socialGroup.PATCH("/collections/folders/:id", collectionAPI.UpdateFolder)
		...
		if bookListAPI != nil {
			...
			socialGroup.PATCH("/booklists/:id", bookListAPI.UpdateBookList)
