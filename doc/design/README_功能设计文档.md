...
本次v2.1架构升级重点：
- ✅ **模块边界优化**：明确Reading Task/User Level/Wallet Service职责
- ✅ **Go/Python混合架构**：AI模块分层设计
- ✅ **事件驱动完善**：强制事件发布机制
- ✅ **Saga事务模式**：分布式事务一致性保证
- ✅ **AI强制流式接口**：降低用户延迟感知90%
...
- [**青羽平台模块化架构设计v2.1**](./青羽平台模块化架构设计v2.1.md) - 完整架构设计和模块划分

### 重构规划文档 🆕

- [**架构重构总结v3.0**](./重构规划/架构重构总结v3.0.md) - 重构背景、目标、实施路线图
- [**模块边界优化方案**](./重构规划/模块边界优化方案.md) - Reading Task/User Level/Wallet/Monetization边界
- [**Saga事务模式设计**](./core/Saga事务模式设计.md) - 分布式事务一致性
- [**事件驱动架构设计**](./core/事件驱动架构设计.md) - EventBus增强、强制事件方法
- [**事件驱动改造清单**](./重构规划/事件驱动改造清单.md) - Service方法事件发布清单
...
### 1. AI服务模块 (AI Service) - v2.1架构升级 🆕

**总体完成度**: 85% ✅ | **架构版本**: v2.1 (Go/Python混合)

**v2.1有效文档**:

| 设计文档 | 状态 | 架构版本 | 优先级 |
|---------|------|---------|--------|
| [Python AI Agent系统架构设计](./ai/07.Python_AI_Agent系统架构设计.md) | ✅ 已完成 | v2.1 | 🔥 最高 |
| [Go AI代理层设计](./ai/08.Go_AI代理层设计.md) | ✅ 已完成 | v2.1 | 🔥 最高 |
| [Agent工具调用集成设计](./ai/09.Agent工具调用集成设计.md) | ✅ 已完成 | v2.1 | 🔥 最高 |
| [RAG检索增强系统设计](./ai/10.RAG检索增强系统设计.md) | ✅ 已完成 | v2.1 | 🔥 最高 |
| [RAG事件驱动索引设计](./ai/11.RAG事件驱动索引设计.md) | ✅ 已完成 | v2.1 | ⭐ 高 |
| [AI流式接口规范](./ai/12.AI流式接口规范.md) | ✅ 已完成 | v2.1 | 🔥 最高 |

**v2.0归档文档** (已移至 `ai/archived/`):
- ~~AI服务架构设计~~ → 已被07+08取代
- ~~AI功能总体设计~~ → 架构已重构
- ~~AI适配器模块~~ → 已整合到08
- ~~AI聊天功能设计~~ → 已被12+Agent取代
- ~~AI流式响应设计~~ → 已被12取代
- ~~AI上下文管理设计~~ → 需按RAG重新设计

**核心功能**:
- ✅ Go/Python混合架构（Go代理+Python AI核心）
- ✅ Python AI Agent系统（工具调用、多Agent协作）
- ✅ RAG检索增强（向量化、知识库、智能检索）
- ✅ 强制流式接口（SSE，降低延迟感知90%）
- ✅ 事件驱动索引（文档更新自动向量化）

**详见**：[AI模块README](./ai/README.md)
