...
| `design/modules/02-writing/README.md` | 写作创作模块设计文档 |
| `design/modules/03-reading/README.md` | 阅读器模块设计文档 |
...
| 原目录 | 目标模块 | 状态 |
|--------|---------|------|
| `writing/` | `modules/02-writing/` | 待迁移 |
| `reading/` | `modules/03-reading/` | 待迁移 |
| `阅读端/` | `modules/03-reading/` | 待迁移 |
