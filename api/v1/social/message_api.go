...
// @Success 200 {object} response.APIResponse{data=dto.GetMessagesResponse}
// @Failure 400 {object} response.APIResponse "参数错误"
// @Failure 403 {object} response.APIResponse "无权访问"
...
// @Success 200 {object} response.APIResponse{data=dto.SendMessageResponse}
// @Failure 400 {object} response.APIResponse "参数错误"
// @Failure 403 {object} response.APIResponse "无权访问"
// @Failure 404 {object} response.APIResponse "会话不存在"
...
// @Success 200 {object} response.APIResponse{data=dto.CreateConversationResponse}
// @Failure 400 {object} response.APIResponse "参数错误"
