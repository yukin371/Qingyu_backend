...
func TestCollectionAPI_GetCollections_Success(t *testing.T) {
	...
	expectedCollections := []*readerModels.Collection{
		func() *readerModels.Collection {
			c := &readerModels.Collection{BookID: primitive.NewObjectID().Hex(), Note: "收藏1"}
			c.ID = primitive.NewObjectID()
			return c
		}(),
		func() *readerModels.Collection {
			c := &readerModels.Collection{BookID: primitive.NewObjectID().Hex(), Note: "收藏2"}
			c.ID = primitive.NewObjectID()
			return c
		}(),
	}
...
func TestCollectionAPI_GetFolders_Success(t *testing.T) {
	...
	expectedFolders := []*readerModels.CollectionFolder{
		func() *readerModels.CollectionFolder {
			f := &readerModels.CollectionFolder{Name: "收藏夹1"}
			f.ID = primitive.NewObjectID()
			return f
		}(),
		func() *readerModels.CollectionFolder {
			f := &readerModels.CollectionFolder{Name: "收藏夹2"}
			f.ID = primitive.NewObjectID()
			return f
		}(),
	}
...
func TestCollectionAPI_GetPublicCollections_Success(t *testing.T) {
	...
	expectedCollections := []*readerModels.Collection{
		func() *readerModels.Collection {
			c := &readerModels.Collection{BookID: primitive.NewObjectID().Hex(), Note: "公开收藏1"}
			c.ID = primitive.NewObjectID()
			return c
		}(),
		func() *readerModels.Collection {
			c := &readerModels.Collection{BookID: primitive.NewObjectID().Hex(), Note: "公开收藏2"}
			c.ID = primitive.NewObjectID()
			return c
		}(),
	}
...
func TestCollectionAPI_GetCollectionsByTag_Success(t *testing.T) {
	...
	expectedCollections := []*readerModels.Collection{
		func() *readerModels.Collection {
			c := &readerModels.Collection{BookID: primitive.NewObjectID().Hex(), Note: "推荐书籍1", Tags: []string{"推荐"}}
			c.ID = primitive.NewObjectID()
			return c
		}(),
	}
