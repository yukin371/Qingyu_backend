...
type BookDetailRepository interface {
	// 继承基础CRUD接口
	base.CRUDRepository[*bookstore2.BookDetail, string]
	...
	GetByAuthorID(ctx context.Context, authorID string, limit, offset int) ([]*bookstore2.BookDetail, error)
	...
	GetByBookID(ctx context.Context, bookID string) (*bookstore2.BookDetail, error)
	GetByBookIDs(ctx context.Context, bookIDs []string) ([]*bookstore2.BookDetail, error)
	UpdateAuthor(ctx context.Context, bookID string, authorID string, authorName string) error
	...
	BatchUpdatePublisher(ctx context.Context, bookIDs []string, publisher string) error
	BatchUpdateTags(ctx context.Context, bookIDs []string, tags []string) error
	BatchUpdateCategories(ctx context.Context, bookIDs []string, categoryIDs []string) error
