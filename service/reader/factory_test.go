...
func (m *MockFactoryReadingProgressPort) GetTotalReadingTime(ctx context.Context, userID string) (int64, error) {
	return 0, nil
}
...
func (m *MockFactoryReadingProgressPort) DeleteReadingProgress(ctx context.Context, userID, bookID string) error {
	return nil
}
...
func (m *MockFactoryAnnotationPort) DeleteAnnotation(ctx context.Context, annotationID string) error {
	return nil
}
...
func (m *MockFactoryAnnotationPort) BatchCreateAnnotations(ctx context.Context, annotations []*reader.Annotation) error {
	return nil
}
