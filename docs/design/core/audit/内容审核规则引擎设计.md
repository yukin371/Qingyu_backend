...
- 这里负责：内容审核规则引擎的历史设计方案，包括规则接口、内置规则、管理机制与性能优化思路。
- 不负责：当前审核系统实现事实、当前规则配置状态、现行 API 或运行时 owner。

## Recommended Read Path

1. [README.md](./README.md)
2. [审核系统数据模型设计.md](./审核系统数据模型设计.md)
...
- 本页更适合解释规则引擎当时如何设计，不适合作为当前实现事实的唯一依据。

## Quick Section Map

| 如果你想看 | 直接跳到 |
|------|------|
| 为什么需要规则引擎与实现情况 | 见“1. 为什么需要这个设计” |
| 整体架构与核心接口 | 见“2. 架构设计”“3. 核心接口设计” |
| 各类内置规则 | 见“4. 内置规则实现” |
| 规则管理、默认加载和扩展方式 | 见“5. 规则管理”“6. 默认规则加载”“7. 规则扩展” |
| 性能、架构关系、未来扩展与实现参考 | 见“8. 性能优化”到“11. 实现参考” |

## Quick Takeaways

- 这篇最有价值的地方，是它把规则引擎接口、内置规则与扩展机制整合到了一份可跳读设计稿里。
- 如果你只关心规则引擎主线，优先看“2. 架构设计”“3. 核心接口设计”“4. 内置规则实现”“5. 规则管理”。
- “已实现”属于历史文档口径，不应直接视为当前代码状态。

## Skip Guide

- 只想知道“规则引擎怎么组织”：看“2. 架构设计”“3. 核心接口设计”。
- 只想知道“有哪些内置规则”：看“4. 内置规则实现”。
