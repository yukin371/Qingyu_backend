...
- current-bounded: 仅承载改进建议与优先级，不代表已实现或已排期

## Recommended Read Path

1. 先读本页的“优先级标记说明”和八大改进方向。
2. 再读 `AI写作工具改进可行性分析.md` 看可行性与实施建议。
3. 如需实施顺序，再读 `AI写作工具分阶段实施计划.md`。

## Boundary

- 这里是方案池，不是承诺清单。
- 其中的 P0/P1 代表建议优先级，不代表已进入开发。
- 若要判断当前落地状态，应转读 `phase3/` 和 `agent/` 主线文档。
...
- 只想确认当前实现：跳过全文，直接看主线文档。
- 只想做排期：重点看 P0/P1 段落即可。
