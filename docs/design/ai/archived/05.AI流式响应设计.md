...
- current-bounded: 旧版 AI 流式响应方案，现已被统一流式接口规范替代

## Recommended Read Path

1. 先读 `../README.md`。
2. 再读 `../streaming/12.AI流式接口规范.md`。
3. 需要对照旧版 SSE 方案时，再看本文件。

## Boundary

- 本页是被替代的旧流式方案。
- 当前流式约束与接口风格应以 `12.AI流式接口规范.md` 为准。
- 不应在此继续追加 today 规范。
...
- 这是旧流式响应设计稿。
- 当前流式 owner 已迁到 `streaming/12`。

## Skip Guide

- 只看当前流式规范：跳过本文件。
- 只做 SSE 旧方案对照：看目标、技术选型和架构设计即可。
