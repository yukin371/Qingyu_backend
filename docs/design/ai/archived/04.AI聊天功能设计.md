...
- current-bounded: 旧版 AI 聊天功能设计，现已被流式接口规范与 Agent 主线替代

## Recommended Read Path

1. 先读 `../README.md`。
2. 再读 `../streaming/12.AI流式接口规范.md` 与 `../agent/07.Python_AI_Agent系统架构设计.md`。
3. 需要回看旧聊天式能力拆分时，再读本文件。

## Boundary

- 本页是旧聊天方案，不再承担当前对话能力 owner。
- 当前聊天/生成能力边界已迁到流式接口与 Agent 主线。
- 不适合作为 today 对话能力设计依据。
...
- 这是旧版聊天功能设计稿。
- 当前对话能力已被新的流式与 Agent 方案替代。

## Skip Guide

- 只看当前对话方案：跳过本文件。
- 只看旧聊天能力范围：看需求概述和功能设计即可。
