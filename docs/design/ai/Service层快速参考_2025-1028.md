...
**状态**: ✅ 已完善  
**文档**: [Service层完善实施总结_2025-1028.md](./Service层完善实施总结_2025-1028.md)

## Page Role

- legacy-reference
- current-owner: `design/ai/`
- current-bounded: 2025-10-28 这轮 Service 层调整的历史速查页

## Recommended Read Path

1. 先读 `Service层完善实施总结_2025-1028.md`。
2. 再把本文件当速查表使用。
3. 需要当前 AI 主线时，回 `README.md` 与 `agent/`。

## Boundary

- 本页是历史快查资料，不是当前 Service 层 owner。
- 其中的方法、文件路径和能力范围都应结合现行代码复核。
- 当前主线判断不应只依赖本页。
...
- 这页价值在于“当时改了哪三类 Service，以及大概做了什么”。
- 它不是实时文档。

## Skip Guide

- 只看当前事实：跳过本文件。
- 只做历史速查：直接看三大核心 Service。
...
- **实施总结**: [Service层完善实施总结_2025-1028.md](./Service层完善实施总结_2025-1028.md)
- **代码位置**: `src/services/`
  - `tool_service.py`
  - `agent_service.py`
  - `rag_service.py`
