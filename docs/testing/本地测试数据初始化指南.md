...
本文档负责“如何准备本地测试数据与测试账号”。如果你缺少书籍样本、测试用户或种子导入路径，先看这里。

## Page Role

- 这里负责：初始化小说数据、创建测试账号、说明数据范围。
- 不负责：完整测试执行流程、API 测试分层、部署与运维说明。

## Recommended Read Path

1. [README_当前指南.md](./README_当前指南.md)
2. [../../migration/seeds/README.md](../../migration/seeds/README.md)
3. [../../config/README.md](../../config/README.md)
4. [集成测试使用指南.md](./集成测试使用指南.md)
...
确保当前数据库配置口径正确。配置加载结构以 [../../config/README.md](../../config/README.md) 与 `configs/` 目录为准，下面示例仅用于说明关键字段：
...
- [小说导入详细指南](../../migration/seeds/README.md)
- [API 文档入口](../api/README.md)
- [数据库文档入口](../database/README.md)
