...
| **脚本使用说明** | `scripts/testing/README.md` | 脚本目录入口文档 |
...
# 启动 Python 服务
cd Qingyu-Ai-Service && python run_grpc_server.py
...
# Python 测试
cd Qingyu-Ai-Service && python tests\test_grpc_phase3.py
```
...
- [测试执行说明](./Ai微服务测试执行说明_2025-10-31.md) - 执行步骤
...
- [Python 服务端](../../../Qingyu-Ai-Service/src/grpc_service/server.py)
